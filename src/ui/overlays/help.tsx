...
const SECTIONS: KeySection[] = [
  ...
  },
  {
    ...
    bindings: [
      ...
      { keys: "e", description: "React to message (emoji picker)" },
      { keys: "f", description: "Forward to another chat" },
      { keys: "d", description: "Delete message (confirm)" },
      { keys: "s", description: "Save media to ~/Downloads/wa-tui (confirm)" },
      { keys: "y", description: "Yank message text to clipboard" },
      { keys: "gi", description: "Contact / group info" },
  ...
  },
  {
    ...
    bindings: [
      ...
      { keys: "Esc", description: "Cancel reply / back to NORMAL" },
      ...
      { keys: "@", description: "DM: file picker · Group: mention picker" },
      { keys: "Drag-drop file", description: "Auto-attach as media" },
    ],
  },
  {
    title: "@ Completion (INSERT)",
    bindings: [
      { keys: "Tab / Enter", description: "Accept selected entry" },
